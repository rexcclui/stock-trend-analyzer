      ...
      <div style={{
        ...
        <ResponsiveContainer>
          ...
          >
            ...
            {/* Volume Breakthrough Markers */}
            <Customized
              component={(props) => (
                <CustomVolumeBreakthroughMarkers
                  {...props}
                  signals={signals}
