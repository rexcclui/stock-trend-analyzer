...
/**
 * Renders zone lines for all reversed found channels.
 ...
 * @param {Array} props.revAllChannels - Array of all reversed found channels
 * @param {Object} props.revAllChannelZones - Zones data for each reversed channel
 ...
 */
const RevAllChannelZones = (props) => {
  const { revAllChannelEnabled, revAllChannels, revAllChannelZones, revAllChannelsVisibility, chartDataWithZones } = props
...
export default RevAllChannelZones
